...
#define MAIN_TEMP_FONT_SIZE 5
#define MAIN_TEMP_START_Y (HEADER_START_Y + (HEADER_FONT_SIZE * 7 + 14))
#define FRIDGE_TEMP_START_X (MIDDLE_BAR_X/2 - (4*5*MAIN_TEMP_FONT_SIZE + 3*MAIN_TEMP_FONT_SIZE)/2)
#define FRIDGE_TEMP_END_X (FRIDGE_TEMP_START_X + (4*5*MAIN_TEMP_FONT_SIZE + 3*MAIN_TEMP_FONT_SIZE))
#define BEER_TEMP_START_X (MIDDLE_BAR_X + MIDDLE_BAR_X/2) - (4*5*MAIN_TEMP_FONT_SIZE + 3*MAIN_TEMP_FONT_SIZE)/2
#define BEER_TEMP_END_X (BEER_TEMP_START_X + (4*5*MAIN_TEMP_FONT_SIZE + 3*MAIN_TEMP_FONT_SIZE))
