...
public:
   ...
   */
  void sendStateNotification(const char *beerAnnotation = nullptr,
                             const char *fridgeAnnotation = nullptr) {
   ...
   * \param fridgeAnnotation - Annotation for the beer
   */
  void printTemperatures(const char *beerAnnotation,
                         const char *fridgeAnnotation) {
